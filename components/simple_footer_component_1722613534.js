...
*/
Vue.component("simple_footer_component_1722613534", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BlockChain Analytics Hub
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain insights into the latest blockchain data with our powerful analytics platform. Stay ahead of the curve and make informed decisions.
                    </div>
                </div>
            </div>
        </footer> 
